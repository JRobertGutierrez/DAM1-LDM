...
ContentSlider.buildpagination=function(sliderid){
	...
	pcontent+='<a href="#" style="font-weight: bold;" onClick=\"ContentSlider.turnpage(\''+sliderid+'\', parseInt(this.getAttribute(\'rel\'))); return false\">'+(slider.nextText || "Siguiente")+'</a>'
...
ContentSlider.turnpage=function(sliderid, thepage){
	...
	//Set "Siguiente" pagination link's (last link within pagination DIV) "rel" attribute to the next DIV number to show
